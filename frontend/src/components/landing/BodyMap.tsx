...
const BODY_PARTS: BodyPart[] = [
  ...
  },
  {
    id: "torso",
    label: "Torso",
    d: "M 85.0 32.799 H 120.102 C 120.35 52 120.0 72 118.8 90 C 117.8 102 116.2 110 113.5 115.5 C 110.5 118 106 119 102.5 118.75 C 99 119 94.5 118 91.5 115.5 C 88.8 110 87.2 102 86.2 90 C 85.5 75 85.1 52 85.0 32.799 Z",
  },
  {
    id: "leftArm",
    label: "Left arm",
  ...
  },
  {
    ...
    d: "m 89.010947,101.51035 h 1.061756 c 5.75472,0 10.387577,3.48197 10.387577,7.80711 v 65.39312 c 0,4.32514 -4.632857,7.8071 -10.387577,7.8071 h -1.061756 c -5.754719,0 -10.38758,-3.48196 -10.38758,-7.8071 v -65.39312 c 0,-4.32514 4.632861,-7.80711 10.38758,-7.80711 z",
  },
  {
    id: "rightLeg",
    label: "Right leg",
    transform: "matrix(0.99812088,0.06127571,0.01525473,0.99988364,0,0)",
    d: "m 112.33839,100.273 h 1.06176 c 5.75472,0 10.38758,3.48197 10.38758,7.8071 v 65.39313 c 0,4.32514 -4.63286,7.8071 -10.38758,7.8071 h -1.06176 c -5.75472,0 -10.38758,-3.48196 -10.38758,-7.8071 V 108.0801 c 0,-4.32513 4.63286,-7.8071 10.38758,-7.8071 z",
  },
  {
    id: "rightHand",
    label: "Right hand",
...
export function BodyMap() {
  ...
  const handlePartEnter = useCallback((part: BodyPart) => {
    return (e: PointerEvent<SVGPathElement>) => {
      setHoveredPartId(part.id);
      setTooltip({ label: part.label, x: e.clientX, y: e.clientY });
    };
  }, []);
      ...
      >
        <defs>
          ...
          <clipPath id={clipPathId} clipPathUnits="userSpaceOnUse">
            <path transform="translate(-59.365521)" d={OUTLINE_D} />
          </clipPath>
        </defs>

        <g clipPath={`url(#${clipPathId})`}>
          <g id="layer1" transform="translate(-59.365521)">
            {BODY_PARTS.map((part) => (
              <path
                key={part.id}
                id={part.id}
        ...
        <g transform="translate(-59.365521)" pointerEvents="none">
          <path d={OUTLINE_D} fill="none" stroke="black" strokeWidth={0.6} />
        </g>
      </svg>
